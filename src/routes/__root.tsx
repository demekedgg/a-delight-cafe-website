...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "A Delight Coffee brings the heritage of Ethiopian specialty coffee to California. Single-origin Yirgacheffe, Sidama, and Guji — launching soon." },
