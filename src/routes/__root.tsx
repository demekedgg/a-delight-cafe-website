...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "A Delight Cafe brings the heritage of Ethiopian specialty coffee to Pleasanton, California. Single-origin Yirgacheffe, Sidama, and Guji — opening soon." },
      { name: "author", content: "A Delight Cafe" },
